...
public class ItemTofuSlab extends ItemBlock {
    public ItemTofuSlab(BlockTofuSlab block) {
        super(block);
    }

    @Override
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        BlockTofuSlab slab = (BlockTofuSlab) getBlock();
        ...
        if (!itemstack.isEmpty() && player.canPlayerEdit(pos.offset(facing), facing, itemstack)) {
            ...
            if (blockState.getBlock() == slab) {
                ...
                BlockTofuSlab.EnumBlockTofuSlab type = blockState.getValue(BlockTofuSlab.HALF);
                if ((facing == EnumFacing.UP && type.equals(BlockTofuSlab.EnumBlockTofuSlab.BOTTOM) || facing == EnumFacing.DOWN && type.equals(BlockTofuSlab.EnumBlockTofuSlab.FULL))) {
                    IBlockState newState = blockState.withProperty(BlockTofuSlab.HALF, BlockTofuSlab.EnumBlockTofuSlab.FULL);
    ...
    public boolean canPlaceBlockOnSide(World worldIn, BlockPos pos, EnumFacing side, EntityPlayer player, ItemStack stack) {
        ...
        if (blockState.getBlock() == getBlock()) {
            boolean flag = blockState.getValue(BlockTofuSlab.HALF) == BlockTofuSlab.EnumBlockTofuSlab.FULL;
