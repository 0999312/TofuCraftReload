...
import cn.mcmod.tofucraft.block.mecha.BlockTFCrasher;
...
public class TileEntityTFCrasher extends TileEntityProcessorBaseInventoried implements ISidedInventory {

    private static final int POWER = 10;

    public TileEntityTFCrasher() {
    ...
    public void onWork() {
        ...
        processTime++;
        if (this.blockType instanceof BlockTFCrasher)
            BlockTFCrasher.setState(true, this.getWorld(), pos);
        drain(POWER, false);
        markDirty();
    }
    ...
    public void failed() {
        ...
        if (this.blockType instanceof BlockTFCrasher)
            BlockTFCrasher.setState(false, this.getWorld(), pos);
        processTime = 0;
    ...
    public String getName() {
        return "container.tofucraft.tfcrasher";
    }
