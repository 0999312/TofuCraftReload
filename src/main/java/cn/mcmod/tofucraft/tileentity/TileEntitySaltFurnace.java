...
public class TileEntitySaltFurnace extends TileEntityLockable implements ITickable, ISidedInventory, IFluidHandler {
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote) {
            ...
            if(burnTime == 0 && this.canBoil(cauldronStat)) {
                ...
                ItemStack fuleStack = this.furnaceItemStacks.get(0);
                ...
                if(burnTime > 0) {
                    ...
                    if(fuleStack != null) {
                        ...
                        if (fuleStack.getCount() == 0)
                        {
                            ItemStack item1 = fuleStack.getItem().getContainerItem(fuleStack);
    ...
    {
        return i == 0 ? TileEntityFurnace.isItemFuel(itemstack) : i == 2 ? FluidUtil.getFluidContained(itemstack).isFluidEqual(nigari) : false;
    }
    @Override
