...
public class GuiTFOven extends GuiContainer {
    private static final ResourceLocation TXTURE = new ResourceLocation("tofucraft", "textures/gui/tf_oven.png");
    private final TileEntityTFOven tileFurnace;

    public GuiTFOven(InventoryPlayer inventory, TileEntityTFOven storageMachine) {
        super(new ContainerTFOven(inventory, storageMachine));
