...
public class CTTFCrusher {
    ...
    private static final class Removal implements IAction
    {
        ...
        public void apply()
        {
        	CrasherRecipes.ClearRecipe(itemInput);
        }

        @Override
        public String describe()
        {
            return "Removing a recipe for ToFu Crusher";
        }
    }
    ...
    private static final class Addition implements IAction
    {
        ...
        public void apply()
        {
        	CrasherRecipes.addRecipe(itemInput, itemOutput);
        }

        @Override
        public String describe()
        {
            return "Adding a recipe for ToFu Crusher";
        }
    }
	...
	private static final class ClearAllRecipe implements IAction
    {
        ...
        public void apply()
        {
            CrasherRecipes.ClearAllRecipe();
        }

        @Override
        public String describe()
        {
            return "Removing all recipes from ToFu Crusher";
        }
    }
}
