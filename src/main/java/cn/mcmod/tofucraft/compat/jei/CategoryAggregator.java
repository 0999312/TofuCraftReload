...
public class CategoryAggregator implements IRecipeCategory<IRecipeWrapper>{
	...
	public String getTitle() {
		return I18n.format("jei.tofucraft.category.aggregator", new Object[0]);
	}

	@Override
	public String getUid() {
		return "tofucraft.aggregator";
	}
	@Override
