...
public class CategoryCrusher implements IRecipeCategory<IRecipeWrapper>{
	...
	public String getTitle() {
		return I18n.format("jei.tofucraft.category.crusher", new Object[0]);
	}

	@Override
	public String getUid() {
		return "tofucraft.crusher";
	}
	@Override
