...
public class RenderAmmoTest extends Render<EntityAmmoTest> {
    private static final ResourceLocation TEXTURES = new ResourceLocation(TofuMain.MODID, "textures/entity/beam.png");

    public RenderAmmoTest(RenderManager renderManager) {
        super(renderManager);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityAmmoTest entityAmmoTest) {
        return TEXTURES;
    }

    @Override
    public void doRender(EntityAmmoTest entity, double x, double y, double z, float entityYaw, float partialTicks) {
