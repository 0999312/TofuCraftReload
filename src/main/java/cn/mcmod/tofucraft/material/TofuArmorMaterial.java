...
public class TofuArmorMaterial {
    ...
    static
    {
        ...
        DIAMOND = EnumHelper.addArmorMaterial("TOFU_DIAMOND", "tofucraft:textures/armor/armor_diamond", 80, new int[]{3, 8, 6, 3}, 20, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 3.0f); // DIAMOND={3, 8, 6, 3}
    }
}
